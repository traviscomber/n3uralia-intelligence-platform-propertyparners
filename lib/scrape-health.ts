  ...
  try {
    ...
    const [runsRes, sourcesRes, benchmarkRes] = await Promise.all([
      ...
      supabase
        ...
        .in('name', ['Portal Inmobiliario', 'TOCTOC Search', 'TOCTOC Casas', 'icasas.cl', 'icasas.cl Casas', 'Yapo Search', 'Chilepropiedades', 'Realtor International', 'Portal Inmobiliario Benchmark'])
