  ...
  select
    ...
    case
      ...
      when learned.neighborhood_id is not null then
        format(
          'Patrón territorial aprendido con %.1f%% de confianza. Es una sugerencia de revisión: no escribe barrio ni crea asignaciones hasta obtener evidencia determinística o confirmación válida.',
          learned.confidence*100
        )
