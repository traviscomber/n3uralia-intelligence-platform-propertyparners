...
const items = {
  ...
  valuation: { label: 'Valorización', href: '/dashboard/valorizador', icon: icons.valuation },
...
const executiveSections: SidebarSection[] = [
  ...
  { label: 'Administración', items: [items.marketSources, items.marketImport, items.sources, items.settings] },
...
const sellerSections: SidebarSection[] = [
  { label: 'Operación', items: [items.home, items.market, items.valuation, items.properties, items.reports] },
  { label: 'Futuro', items: [items.version2] },
]
