  ...
  return (
    <aside className="flex flex-col w-56 shrink-0 border-r h-full bg-white border-gray-200">
      ...
      <div className="flex items-center gap-2.5 px-4 py-4" style={{ borderBottom: '1px solid #e5e7eb' }}>
        <div className="w-24 shrink-0 rounded-md bg-black px-2 py-1">
          <PPLogo className="h-6 w-auto" priority />
        </div>
        <div>
          <div className="text-sm font-semibold tracking-tight leading-none text-gray-900">Property Partners</div>
          <div className="text-[10px] mt-0.5" style={{ color: '#6b7280' }}>Vitacura intelligence</div>
        </div>
      </div>
              ...
              <li key={item.href}>
                <Link
                  ...
                  style={{
                    ...
                    borderLeft: isActive ? '2px solid #d61f2c' : '2px solid transparent',
                  }}
                >
                  <span style={{ color: isActive ? '#d61f2c' : '#9ca3af' }}>{item.icon}</span>
        ...
        <div className="px-3 py-3" style={{ borderTop: '1px solid #d8e5e2' }}>
          <div className="flex items-center gap-2.5">
            ...
            <div className="min-w-0">
              ...
              <div className="text-[10px] capitalize" style={{ color: '#6b7280' }}>{profile.role}</div>
            </div>
          </div>
        </div>
      )}
