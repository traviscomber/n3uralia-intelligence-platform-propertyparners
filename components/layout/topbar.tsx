  ...
  return (
    <header className="sticky top-0 z-40 flex items-center justify-between border-b border-[var(--n3-line)] bg-[var(--n3-black)] px-6 py-4">
      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-1.5 rounded-full border border-[var(--n3-line)] px-2.5 py-1 text-xs" style={{ background: 'rgba(139,169,167,0.08)', color: 'var(--n3-teal)' }}>
