...
const pdfSource = await fs.readFile(new URL('../lib/reportin-ceo-intelligence-pdf-house-only.ts', import.meta.url), 'utf8')
...
const artifactRouteSource = await fs.readFile(new URL('../app/api/management/reports/ceo-intelligence/[id]/artifact/route.ts', import.meta.url), 'utf8')
