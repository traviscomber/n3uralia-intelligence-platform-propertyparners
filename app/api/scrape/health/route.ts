  ...
  try {
    ...
    const [runsRes, sourcesRes, benchmarkRes, historyRes] = await Promise.all([
      ...
      supabase
        ...
        .in('name', ['Portal Inmobiliario', 'Portal Inmobiliario Arriendos', 'TOCTOC Search', 'icasas.cl', 'Yapo Search', 'Chilepropiedades', 'Realtor International', 'Portal Inmobiliario Benchmark'])
