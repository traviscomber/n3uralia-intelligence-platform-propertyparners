  ...
  return (
    <div className="mx-auto max-w-[1600px] space-y-7 pb-16 text-[#202522]">
      ...
      <section className="grid gap-px bg-[#cfcfcf] lg:grid-cols-3">
        <article className="bg-[#f5f5f5] p-5"><p className="text-[10px] font-bold uppercase tracking-[0.16em] text-[#666]">Mercado</p><p className="mt-2 text-3xl font-semibold">{number(portalListings)}</p><p className="mt-1 text-sm text-[#555]">publicaciones válidas auditadas</p><p className="mt-4 text-xs leading-5 text-[#666]">{number(valuation.sourceReconciliation.currentPortalSaleEligibleListings)} elegibles para venta y {number(valuation.sourceReconciliation.portalListingsQuarantinedByRentIndicator)} con señal de arriendo en cuarentena.</p></article>
