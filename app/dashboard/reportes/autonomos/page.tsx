...
export default function AutonomousReportsPage() {
  return <div className="mx-auto max-w-7xl space-y-8 pb-16">
    <header className="border-b border-[var(--n3-line)] pb-7">
      <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[var(--n3-teal)]">Sistema autónomo · fuentes auditadas</p>
      <h1 className="mt-3 text-4xl font-semibold text-[var(--n3-text-light)]">Reportes por audiencia</h1>
      <p className="mt-3 max-w-3xl text-sm leading-6 text-[var(--n3-text-muted)]">La misma verdad de origen, presentada con el alcance que corresponde a cada rol. No se generan recomendaciones, proyecciones ni datos ausentes.</p>
    </header>
