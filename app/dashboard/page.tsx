...
export default async function DashboardHome() {
  ...
  return <div className="mx-auto max-w-[1600px] space-y-7 pb-16">
    <header className="border border-[var(--n3-line)] bg-[#0c1111] p-8 lg:p-10"><p className="text-[10px] font-bold uppercase tracking-[0.24em] text-[#ff766f]">Property Partners Vitacura · uso interno</p><h1 className="mt-4 text-4xl font-semibold">Resumen de gestión</h1><p className="mt-3 max-w-3xl text-sm leading-6 text-[var(--n3-text-muted)]">Indicadores comerciales acumulados a junio de 2026. Los módulos de gestión corporativa y reportes contienen el detalle para CEO y dirección.</p><div className="mt-6 flex flex-wrap gap-2"><Link href="/dashboard/ceo" className="bg-[#d7332b] px-4 py-2 text-xs font-semibold text-white">Resumen ejecutivo</Link><Link href="/dashboard/inteligencia" className="border border-[var(--n3-line)] px-4 py-2 text-xs font-semibold">Gestión corporativa</Link><Link href="/dashboard/reportes/autonomos" className="border border-[var(--n3-line)] px-4 py-2 text-xs font-semibold">Reportes</Link></div></header>
