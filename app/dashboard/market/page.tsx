...
export default function MarketPage() {
  ...
  return <div className="mx-auto max-w-[1600px] space-y-7 pb-16">
    ...
    <section className="grid gap-5 lg:grid-cols-[1.2fr_1fr]">
      ...
      <article className="border border-[#d7332b] bg-[#160d0c] p-6"><p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#ff766f]">Control metodológico</p><h2 className="mt-2 text-xl font-semibold">Sólo métricas respaldadas</h2><p className="mt-4 text-sm leading-6 text-[var(--n3-text-muted)]">No se publican promedios, velocidad, absorción, inventario ni rankings provenientes de tablas operativas heredadas. Tampoco se sustituyen con estimaciones.</p><p className="mt-4 border-l-2 border-[#d7332b] pl-3 text-xs leading-5 text-[var(--n3-text-muted)]">Esta vista utiliza únicamente oferta Portal, inscripciones CBRS y polígonos presentes en el paquete auditado.</p></article>
    </section>
