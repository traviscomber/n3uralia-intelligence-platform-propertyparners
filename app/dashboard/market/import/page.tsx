                  ...
                  <table className="min-w-full text-left text-sm">
                    ...
                    <tbody>
                      {result.preview.map((row) => {
                        ...
                        if (kind === 'benchmark_data') {
                          ...
                          return (
                            <tr key={`row-${kind}-${keyField}`} className="border-t" style={{ borderColor: '#eef2f2' }}>
                              <td className="px-4 py-3 font-medium text-gray-900">{benchmarkRow.source}</td>
                        ...
                        return (
                          <tr key={`row-${kind}-${keyField}`} className="border-t" style={{ borderColor: '#eef2f2' }}>
                            <td className="px-4 py-3 font-medium text-gray-900">{marketRow.neighborhood}</td>
      ...
      "recorded_at": "2026-07-15T00:00:00.000Z"
          ...
          <div className="rounded-xl bg-white p-6 shadow-sm" style={{ border: '1px solid #d8e5e2' }}>
            ...
            <ul className="mt-3 space-y-2 text-sm" style={{ color: '#555a56' }}>
              ...
              <li>• `kind=market_data` actualiza `market_data` y el historico `neighborhood_market_data`.</li>
